...
public static partial class CellPatternCells
{
    private static void InitCellPatternCells()
    {
        ...
        var TowOutsideDiagonalNoPlayerMiddle = new CellPatternCell()
        {
            ...
            CellState = new string[] { @"recJAi8YoTOQmzhfH" },
            Name = @"TowOutsideDiagonal:NoPlayer:Middle",
            CellIndex = 4,
            CellStateId = 2,
            CellCellState = 42
        };

        List.Add(TowOutsideDiagonalNoPlayerMiddle);
        ByEnum[CellPatternCellsEnum.TowOutsideDiagonalNoPlayerMiddle] = TowOutsideDiagonalNoPlayerMiddle;
        
            
        var DiagonalWinPlayerMiddle = new CellPatternCell()
        {
            CellPatternCellId = @"recXIhNnjJIZf7xNR",
            createdTime = DateTime.Parse("2020-12-02T21:11:48Z"),
            Cell = new string[] { @"rec35HZOaRy6ge0jk" },
            CellPattern = new string[] { @"recjHQghxgtsx3sDU" },
            CellState = new string[] { @"rec0xQjo4VL3DFTXg" },
        ...
        var TowOutsideDiagonalPlayerTopLeft = new CellPatternCell()
        {
            ...
            CellPattern = new string[] { @"recg1ttw7l3n96PDG" },
            CellState = new string[] { @"rec0xQjo4VL3DFTXg" },
            Name = @"TowOutsideDiagonal:Player:TopLeft",
            CellIndex = 0,
            CellStateId = 0,
            CellCellState = 00
        };

        List.Add(TowOutsideDiagonalPlayerTopLeft);
        ByEnum[CellPatternCellsEnum.TowOutsideDiagonalPlayerTopLeft] = TowOutsideDiagonalPlayerTopLeft;
        ...
        {
            CellPatternCellId = @"recgARZ3wIo6805jL",
            createdTime = DateTime.Parse("2020-12-02T21:10:57Z"),
            Cell = new string[] { @"rec50MWM91QHzlEzO" },
            CellPattern = new string[] { @"recjHQghxgtsx3sDU" },
            CellState = new string[] { @"rec0xQjo4VL3DFTXg" },
        ...
        var TowOutsideDiagonalPlayerBottomRight = new CellPatternCell()
        {
            ...
            CellPattern = new string[] { @"recg1ttw7l3n96PDG" },
            CellState = new string[] { @"rec0xQjo4VL3DFTXg" },
            Name = @"TowOutsideDiagonal:Player:BottomRight",
            CellIndex = 8,
            CellStateId = 0,
            CellCellState = 80
        };

        List.Add(TowOutsideDiagonalPlayerBottomRight);
        ByEnum[CellPatternCellsEnum.TowOutsideDiagonalPlayerBottomRight] = TowOutsideDiagonalPlayerBottomRight;
        ...
        {
            CellPatternCellId = @"recma9mMG2XEkgQlm",
            createdTime = DateTime.Parse("2020-12-02T21:11:48Z"),
            Cell = new string[] { @"recczW2Y4WMv9buZ8" },
            CellPattern = new string[] { @"recjHQghxgtsx3sDU" },
            CellState = new string[] { @"rec0xQjo4VL3DFTXg" },
