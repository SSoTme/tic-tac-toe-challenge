...
public static partial class CellPatternCells
{
    private static void InitCellPatternCells()
    {
        ...
        var TowOutsideDiagonalPlayerATopLeft = new CellPatternCell()
        {
            ...
            CellPattern = new string[] { @"recg1ttw7l3n96PDG" },
            CellState = new string[] { @"rec0xQjo4VL3DFTXg" },
            Name = @"TowOutsideDiagonal:PlayerA:TopLeft",
            CellIndex = 0,
            CellStateId = 0,
            CellCellState = 00
        };

        List.Add(TowOutsideDiagonalPlayerATopLeft);
        ByEnum[CellPatternCellsEnum.TowOutsideDiagonalPlayerATopLeft] = TowOutsideDiagonalPlayerATopLeft;
        ...
        var TowOutsideDiagonalPlayerABottomRight = new CellPatternCell()
        {
            ...
            CellPattern = new string[] { @"recg1ttw7l3n96PDG" },
            CellState = new string[] { @"rec0xQjo4VL3DFTXg" },
            Name = @"TowOutsideDiagonal:PlayerA:BottomRight",
            CellIndex = 8,
            CellStateId = 0,
            CellCellState = 80
        };

        List.Add(TowOutsideDiagonalPlayerABottomRight);
        ByEnum[CellPatternCellsEnum.TowOutsideDiagonalPlayerABottomRight] = TowOutsideDiagonalPlayerABottomRight;
