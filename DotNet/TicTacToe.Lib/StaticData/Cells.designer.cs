...
public static partial class Cells
{
    private static void InitCells()
    {
        ...
        var TopLeft = new Cell()
        {
            ...
            RotateFrom = @"TopRight",
            RotateDescription = @"From TopRight to TopLeft",
        ...
        var Top = new Cell()
        {
            ...
            RotateDescription = @"From MiddleRight to Top",
        ...
        var TopRight = new Cell()
        {
            ...
            RotateDescription = @"From BottomRight to TopRight",
        ...
        var MiddleLeft = new Cell()
        {
            ...
            RotateFrom = @"Top",
            RotateDescription = @"From Top to MiddleLeft",
        ...
        var MiddleRight = new Cell()
        {
            ...
            RotateFrom = @"Bottom",
            RotateDescription = @"From Bottom to MiddleRight",
        ...
        var BottomLeft = new Cell()
        {
            ...
            RotateFrom = @"TopLeft",
            RotateDescription = @"From TopLeft to BottomLeft",
        ...
        var Bottom = new Cell()
        {
            ...
            RotateDescription = @"From MiddleLeft to Bottom",
        ...
        var BottomRight = new Cell()
        {
            ...
            RotateDescription = @"From BottomLeft to BottomRight",
