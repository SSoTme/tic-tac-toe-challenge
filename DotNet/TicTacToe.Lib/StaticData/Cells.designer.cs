...
public static partial class Cells
{
    private static void InitCells()
    {
        ...
        var TopLeft = new Cell()
        {
            ...
            CellIndex = 0,
            CellPatternCells = new string[] { @"recU9O3yxyMeQ1eU4", "recYR4cE90EOVnYD5", "rec91aKNdkT2cw93v", "recclaJuN3LJWLC4N", "recKj18pU9k6V6MAx", "rec50mVjEdQZEZQYw" },
        ...
        var Middle = new Cell()
        {
            ...
            RotateTranslation = new string[] { @"recgdoYW4iJ8gaAha" },
            CellIndex = 4,
            CellPatternCells = new string[] { @"recGP80BxFCLlmgw7", "recWoh5Qk0b1xBV67", "recwQ3ZI5MBVHPKgl", "recPmKMMNhYSxBWJ0", "recaPLycHtpRQfWnE", "recgEASIRl67trnVo" },
        ...
        var BottomRight = new Cell()
        {
            ...
            RotateTranslation = new string[] { @"recgdoYW4iJ8gaAha" },
            CellIndex = 8,
            CellPatternCells = new string[] { @"reclDV8jky7y1JNzH", "rec5D3fwk2h5GzjIB", "recc7o6on6KJC5hrh" },
