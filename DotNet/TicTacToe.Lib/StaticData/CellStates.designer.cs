...
public static partial class CellStates
{
    private static void InitCellStates()
    {
        ...
        var PlayerB = new CellState()
        {
            ...
            SortOrder = 2,
            Id = 1,
            CurrentStateCells = new string[] { @"rec35HZOaRy6ge0jk", "recfSe8zeEdCAtcGq" },
        ...
        var NoPlayer = new CellState()
        {
            ...
            CurrentStateCells = new string[] { @"recxIf3GoDzEtonFU", "recmjtZPRUfoCU2sr", "rec3OzG8nTAkUhjVn", "recTGnKjXTE8LfT3C", "recczW2Y4WMv9buZ8" },
