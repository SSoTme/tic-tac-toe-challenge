...
>
    ...
    <xsl:template match="/*">
        <FileSet>
            <FileSetFiles>                
                <FileSetFile>
                    <RelativePath>TicTacToeBoard.designer.py</RelativePath>
                ...
                </xsl:if></xsl:for-each>)
            {
                ...
                <FileSetFile>
                    <RelativePath>
                        ...
                        <xsl:text>Player.py</xsl:text>
                    </RelativePath>
                    <OverwriteMode>Never</OverwriteMode>
                    <xsl:element name="FileContents" xml:space="preserve">def  <xsl:value-of select="Name"/>Player:    
    None
    public override Cell Play(TicTacToeBoard board)
    {
        ...
        return randomCell;
                ...
                <xsl:for-each select="//AIStrategies/AIStrategy">
                    <FileSetFile>
                        <RelativePath>Strategies/<xsl:value-of select="Name"/>Strategy.py</RelativePath>
                        <OverwriteMode>Never</OverwriteMode>
